...
import bonus1 from "../assets/images/bonus_1_tablet_1788303949604.jpg";
import bonus2 from "../assets/images/bonus_2_tablet_1788303962862.jpg";
import bonus3 from "../assets/images/bonus_3_tablet_1788303974064.jpg";
import bonus4 from "../assets/images/bonus_4_tablet_1788303985612.jpg";
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {bonuses.map((bonus, idx) => (
            <div key={idx} className="bg-white rounded-[24px] border-2 border-[var(--color-primary)]/20 relative shadow-sm overflow-hidden flex flex-col group hover:border-[var(--color-primary)]/50 transition-colors">
              ...
              <div className="w-full bg-slate-50/50 p-6 flex justify-center items-center relative overflow-hidden group-hover:bg-slate-50 transition-colors">
                ...
                <img src={bonus.img} alt={bonus.title} className="h-48 md:h-56 object-contain drop-shadow-xl relative z-10 group-hover:scale-105 transition-transform duration-500" />
              </div>
...
fs.writeFileSync('src/components/BonusesSection.tsx', content);
