  ...
  return (
    <section className="py-16 relative overflow-hidden">
      <div className="max-w-4xl mx-auto text-center px-4 relative z-10">
        ...
        <button onClick={(e) => scrollToOffer(e)} className="bg-[var(--color-cta)] text-[var(--color-on-action)] hover:opacity-90 px-8 py-5 rounded-full text-xl font-bold transition-all inline-flex items-center justify-center shadow-xl shadow-[var(--color-cta)]/30 animate-cta-pulse cursor-pointer w-full md:w-auto">
